...
describe('Credential section styles', () => {
  ...
  it('lets Auth Files quota bars wrap before their blocks overlap', () => {
    ...
    expect(credentialStyles).toMatch(/\.credentialQuotaBarTooltipRight \.credentialQuotaGroupTooltip::after\s*\{[\s\S]*?right:\s*14px;[\s\S]*?left:\s*auto;/)
    expect(credentialStyles).not.toContain('.credentialQuotaBarBlock:nth-child(even)')
